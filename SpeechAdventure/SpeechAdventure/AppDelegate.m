...
//@synthesize window=window_, navController=navController_, director=director_, voiceInputManager=_voiceInputManager;

/*- (OEManager*)voiceInputManager
{
    if (_voiceInputManager == nil)
    {
        _voiceInputManager = [[OEManager alloc] initWithDefaults];
    }
    return _voiceInputManager;
}*/
...
//	[director setProjection:kCCDirectorProjection3D];
    ...
    [director_ pushScene: [StageLoader sceneWithXMLPrefix:@"PopABalloon2-6"]];
